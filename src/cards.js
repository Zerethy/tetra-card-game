...
/**
 * Player-character cards. Strong signature kit (Lv8 relic band: totals 30–34, peaks 8–9).
 * Not a Stage 10 sovereign stack. Kept off ROSTER so bosses never deal them.
 * Rotbriar is the recommended / default bind.
 */
export const DEFAULT_IDENTITY_ID = 'you-rotbriar';
...
export const IDENTITIES = [
  ...
  },
  {
    ...
    name: 'Rotbriar',
    title: 'Sweet-Thorn',
    vibe: 'Dark-druid of the thorn hedge. The briar keeps what it kisses.',
    level: 8,
    top: 8,
    right: 7,
    bottom: 9,
...
export function identityById(id) {
  return IDENTITIES.find((card) => card.id === id) || IDENTITIES.find((card) => card.id === DEFAULT_IDENTITY_ID);
}
...
const LORE = {
  ...
  'you-rotbriar': {
    ...
    flavor: 'Dark-druid of the thorn hedge. The briar keeps what it kisses.',
  },
};
