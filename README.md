...
The **Album** lists every roster card: owned copies face-up, unknown cards as silhouettes, plus your identity pinned as **You**. Before **New Match**, pick **five** owned cards for the duel. **Drag** a card into a slot to add or replace, drag within the five to reorder, or drag a chosen card back onto the album to remove. Click still toggles. The five persist in `localStorage`.
